            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <Button
                  type="submit"
                  variant="primary"
                  className="w-full flex items-center justify-center gap-2 py-4 text-lg font-semibold bg-gradient-to-r from-primary to-purple-600 hover:from-primary-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  loading={loading}
                  disabled={loading}
                >
